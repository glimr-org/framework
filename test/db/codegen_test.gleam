...
pub fn gleam_type_array_of_string_test() {
  schema_parser.gleam_type(schema_parser.Array(schema_parser.String))
  |> should.equal("List(String)")
}

pub fn gleam_type_array_of_int_test() {
  schema_parser.gleam_type(schema_parser.Array(schema_parser.Int))
  |> should.equal("List(Int)")
}

pub fn gleam_type_array_of_float_test() {
  schema_parser.gleam_type(schema_parser.Array(schema_parser.Float))
  |> should.equal("List(Float)")
}

pub fn gleam_type_array_of_bool_test() {
  schema_parser.gleam_type(schema_parser.Array(schema_parser.Boolean))
  |> should.equal("List(Bool)")
}

pub fn gleam_type_nested_array_test() {
  schema_parser.gleam_type(
...
pub fn gleam_type_array_of_uuid_test() {
  schema_parser.gleam_type(schema_parser.Array(schema_parser.Uuid))
  |> should.equal("List(String)")
}

pub fn gleam_type_array_of_timestamp_test() {
  schema_parser.gleam_type(schema_parser.Array(schema_parser.Timestamp))
  |> should.equal("List(String)")
}

pub fn gleam_type_array_of_bigint_test() {
  schema_parser.gleam_type(schema_parser.Array(schema_parser.BigInt))
  |> should.equal("List(Int)")
}
...
pub fn json_encoder_expr_array_of_string_test() {
  schema_parser.json_encoder_expr(
...
pub fn json_encoder_expr_scalar_passthrough_test() {
  schema_parser.json_encoder_expr(schema_parser.String, "model.name")
  |> should.equal("json.string(model.name)")
}

pub fn json_encoder_expr_int_passthrough_test() {
  schema_parser.json_encoder_expr(schema_parser.Int, "model.age")
...
pub fn is_array_true_test() {
  schema_parser.is_array(schema_parser.Array(schema_parser.String))
  |> should.be_true()
}

pub fn is_array_nested_true_test() {
  schema_parser.is_array(
    schema_parser.Array(schema_parser.Array(schema_parser.Int)),
  )
  |> should.be_true()
}
...
pub fn is_array_false_string_test() {
  schema_parser.is_array(schema_parser.String)
  |> should.be_false()
}

pub fn is_array_false_int_test() {
  schema_parser.is_array(schema_parser.Int)
  |> should.be_false()
}

pub fn is_array_false_foreign_test() {
  schema_parser.is_array(schema_parser.Foreign(
    "users",
    option.None,
    option.None,
  ))
...
pub fn gleam_type_enum_test() {
  schema_parser.gleam_type(schema_parser.Enum("status", ["active", "inactive"]))
  |> should.equal("Status")
}

pub fn gleam_type_decimal_test() {
  schema_parser.gleam_type(schema_parser.Decimal(10, 2))
  |> should.equal("String")
}

pub fn gleam_type_blob_test() {
  schema_parser.gleam_type(schema_parser.Blob)
  |> should.equal("BitArray")
}

pub fn gleam_type_time_test() {
  schema_parser.gleam_type(schema_parser.Time)
  |> should.equal("String")
}
...
pub fn decoder_fn_enum_test() {
  schema_parser.decoder_fn(schema_parser.Enum("status", ["active"]))
  |> should.equal("decode.string")
}

pub fn decoder_fn_decimal_test() {
  schema_parser.decoder_fn(schema_parser.Decimal(10, 2))
  |> should.equal("decode.string")
}

pub fn decoder_fn_blob_test() {
  schema_parser.decoder_fn(schema_parser.Blob)
  |> should.equal("decode.bit_array")
}

pub fn decoder_fn_time_test() {
  schema_parser.decoder_fn(schema_parser.Time)
  |> should.equal("decode.string")
}
...
pub fn json_encoder_fn_decimal_test() {
  schema_parser.json_encoder_fn(schema_parser.Decimal(10, 2))
  |> should.equal("json.string")
}

pub fn json_encoder_fn_time_test() {
  schema_parser.json_encoder_fn(schema_parser.Time)
  |> should.equal("json.string")
}

pub fn json_encoder_expr_blob_test() {
  schema_parser.json_encoder_expr(schema_parser.Blob, "model.data")
...
pub fn is_blob_true_test() {
  schema_parser.is_blob(schema_parser.Blob)
  |> should.be_true()
}

pub fn is_blob_false_test() {
  schema_parser.is_blob(schema_parser.String)
  |> should.be_false()
}

pub fn is_enum_true_test() {
  schema_parser.is_enum(schema_parser.Enum("status", ["active"]))
  |> should.be_true()
}

pub fn is_enum_false_test() {
  schema_parser.is_enum(schema_parser.String)
  |> should.be_false()
}
...
pub fn enum_type_name_simple_test() {
  schema_parser.enum_type_name("status")
  |> should.equal("Status")
}

pub fn enum_type_name_multi_word_test() {
  schema_parser.enum_type_name("user_status")
...
pub fn gleam_type_smallint_test() {
  schema_parser.gleam_type(schema_parser.SmallInt)
  |> should.equal("Int")
}

pub fn decoder_fn_smallint_test() {
  schema_parser.decoder_fn(schema_parser.SmallInt)
  |> should.equal("decode.int")
}

pub fn json_encoder_fn_smallint_test() {
  schema_parser.json_encoder_fn(schema_parser.SmallInt)
